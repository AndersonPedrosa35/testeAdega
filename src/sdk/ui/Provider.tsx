...
interface State {
  ...
  filter: boolean
  filterOrderby: boolean
  searchInput: boolean
  toasts: Toast[]
}

type UIElement = 'navbar' | 'cart' | 'modal' | 'filter' | 'filterOrderby' | 'searchInput'
...
interface Context extends State {
  ...
  closeFilter: () => void
  openFilter: () => void
  closeFilterOrderby: () => void
  openFilterOrderby: () => void
  openCart: () => void
  closeCart: () => void
  openModal: () => void
  closeModal: () => void
...
function UIProvider({ children }: PropsWithChildren) {
  ...
  const callbacks = useMemo(
    () => ({
      ...
      openFilterOrderby: () => dispatch({ type: 'open', payload: 'filterOrderby' }),
      closeFilterOrderby: () => dispatch({ type: 'close', payload: 'filterOrderby' }),
      ...
      openSearchInput: () => dispatch({ type: 'open', payload: 'searchInput' }),
      closeSearchInput: () => dispatch({ type: 'close', payload: 'searchInput' }),
