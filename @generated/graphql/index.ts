...
export type CmsFooterFieldsEnum =
  ...
  | 'selos___certificates___listPayment'
  | 'selos___certificates___listPayment___alt'
  | 'selos___certificates___listPayment___children'
  | 'selos___certificates___listPayment___id'
  | 'selos___certificates___listPayment___image'
  | 'selos___certificates___listPayment___link'
  | 'versionStatus';
...
export type CmsFooterSelosCertificates = {
  ...
  listPayment: Maybe<Array<Maybe<CmsFooterSelosCertificatesListPayment>>>;
};
...
export type CmsFooterSelosCertificatesFilterInput = {
  ...
  listPayment: InputMaybe<CmsFooterSelosCertificatesListPaymentFilterListInput>;
};
...
export type CmsFooterSelosCertificatesListPaymentFilterListInput = {
  elemMatch: InputMaybe<CmsFooterSelosCertificatesListPaymentFilterInput>;
};
